        ...
        <div class="fat-footer">
            <div class="fat-footer-grid">
                <div class="crispy-div-info">
                    <p class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img class="site-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/branding/crispy-div-logo-color.svg" alt="<?php echo THEME_NAME . ' home'; ?>" /></a></p>
                    <p class="site-description"><?php echo crispydiv_site_description(); ?> <a href="<?php echo home_url( '/contact/' ); ?>">Reach out</a>.</p>
                </div>
