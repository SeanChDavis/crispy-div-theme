	...
	<main id="site-content">
		...
		<section class="why-wordpress-section">
			...
			<div class="how-we-work-grid general-grid large">
				...
				ob_start();
				?>
				<p>All WordPress websites look quite similar after installation. Where you go from there is up to you. WordPress <a href="https://wordpress.org/plugins/" target="_blank">Plugins</a> are snippets of code that affect the functionality of your website. WordPress <a href="https://wordpress.org/themes/" target="_blank">Themes</a> use the template engine to control the structure and design of your website.
				</p>
				...
				ob_start();
				?>
				<p>Perhaps the best part about WordPress is its <strong>community of enthusiastic users and developers</strong>. Everything from bustling, unofficial support forums to million-dollar businesses has been built within the WordPress ecosystem. It's a world of its own.</p>
			...
			<div class="inner small">
				<div class="other-platforms">
					<div class="description">
						<p><strong>Does that mean WordPress is a Crispy Div requirement?</strong> 🤔 Absolutely not! Crispy Div is a <em>web development</em> agency. WordPress is an option, not a requirement. Take a look at a few Crispy Div websites that don't use WordPress. Whatever your preference or need, we can help you build it.</p>
						<div class="cd-builds">
							<?php
							crispydiv_button(array(
									'text'        => 'PageMotor',
